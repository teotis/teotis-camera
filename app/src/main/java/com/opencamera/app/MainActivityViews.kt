    ...
    companion object {
        fun bind(activity: AppCompatActivity): MainActivityViews {
            ...
            val quickPanel = QuickPanelViews(
                ...
                watermark = activity.findViewById(R.id.buttonQuickWatermark),
            ...
            val settingsPanel = SettingsPanelViews(
                ...
                photoLiveSaveFormat = activity.findViewById(R.id.buttonPhotoLiveSaveFormat),
            ...
            val devConsole = DevConsoleViews(
                ...
                tabLink = activity.findViewById(R.id.buttonDevTabLink),
