...
open class TestAppTextResolver : AppTextResolver(null) {
    ...
    override fun checkInSceneTitle(): String = "Scene"
    override fun checkInStyleTitle(): String = "Style"
    override fun checkInSelectScene(): String = "Select"
    override fun checkInUseStyle(): String = "Use"
    override fun checkInHeadline(): String = "Check-in Style"
    override fun checkInScenarioPortrait(): String = "Portrait"
    override fun checkInScenarioPeoplePlace(): String = "People & Place"
    override fun checkInScenarioObjectPlace(): String = "Object & Place"
    override fun checkInScenarioClarity(): String = "Clarity"
    override fun checkInScenarioDescPortrait(): String = "Close-up portrait highlighting expression and posture"
    override fun checkInScenarioDescPeoplePlace(): String = "People combined with environment to capture atmosphere"
    override fun checkInScenarioDescObjectPlace(): String = "Objects with environment, capturing detail and space"
    override fun checkInScenarioDescClarity(): String = "Multi-frame synthesis for sharper detail"
    override fun checkInScenePrefix(): String = "Scene: "
    override fun checkInFocusMode(): String = " | Focus mode"
    override fun checkInGuidancePortrait(): String = "Tip: keep the subject centered, use depth of field to highlight the focus"
    override fun checkInGuidancePeoplePlace(): String = "Tip: balance the person and environment, leave space for ambiance"
    override fun checkInGuidanceObjectPlace(): String = "Tip: focus on details, use ambient light to enhance texture"
    override fun checkInGuidanceClarity(): String = "Tip: stay steady, multi-frame synthesis will enhance detail"
    override fun checkInDegradedBadge(): String = "Multi-frame unavailable"
    override fun checkInDegradedDepth(): String = "Depth effect unavailable, using Focus mode"
    override fun checkInDegradedMultiframe(): String = "Multi-frame unavailable, using best single-frame"
    ...
    override fun devLinkTimingHeader(): String = "--- Link Timing ---"
    override fun devStatusPrefix(): String = "Status: "
    override fun devModePrefix(): String = "Mode: "
    override fun devCapturePrefix(): String = "Capture: "
    override fun devRecordingPrefix(): String = "Recording: "
    override fun devLastTimingPrefix(): String = " | Last timing: "
    override fun devSlowestTimingPrefix(): String = " | Slowest timing: "
    override fun devLastIssuePrefix(): String = " | Last issue: "
