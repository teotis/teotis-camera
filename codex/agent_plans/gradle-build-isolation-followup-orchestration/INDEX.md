...
| `codex/agent_plans/2026-05-26-agent-handoff-gradle-isolation-index.md` | 02-ledger-and-rules-restoration | 01 |
| `codex/agent_plans/INDEX.md` | 02-ledger-and-rules-restoration | 01 |
| `codex/documentation.md` | 02-ledger-and-rules-restoration | 01 |
| `AGENTS.md` | 02-ledger-and-rules-restoration | 01 |
| `codex/agent_plans/gradle-build-isolation-followup-orchestration/**` | Codex / final audit only after generation | package agents may write only their own `status/*.md` |
...
| --- | --- | --- | --- | --- |
| 01-stage-script-isolation | agent-view | agent-01-stage-script-isolation | `launchers/agent-view-prompts.md#package-01-stage-script-isolation` | `status/01-stage-script-isolation.md` |
| 02-ledger-and-rules-restoration | agent-view | agent-02-ledger-and-rules-restoration | `launchers/agent-view-prompts.md#package-02-ledger-and-rules-restoration` | `status/02-ledger-and-rules-restoration.md` |
...
- Option B: `claude --bg` script — run `bash codex/agent_plans/gradle-build-isolation-followup-orchestration/launchers/dispatch-claude-agents.sh`.
