...
- The prior handoff document `codex/agent_plans/2026-05-26-agent-handoff-gradle-isolation-index.md` is missing in the current workspace.
- `codex/agent_plans/INDEX.md` is the canonical planning index.
...
- `codex/agent_plans/2026-05-26-agent-handoff-gradle-isolation-index.md`
- your assigned status file under `codex/agent_plans/gradle-build-isolation-followup-orchestration/status/`

Forbidden paths:
- `scripts/**`
- Runtime app/core Kotlin files
- Other orchestration package status files
- `codex/agent_plans/gradle-build-isolation-followup-orchestration/INDEX.md`
...
- Recreate `codex/agent_plans/2026-05-26-agent-handoff-gradle-isolation-index.md` as the durable handoff package for this build-isolation work.
...
- Update `codex/agent_plans/INDEX.md` with a link to both:
...
- `codex/agent_plans/INDEX.md` links to the handoff package and orchestration kit.
...
rtk test -f codex/agent_plans/2026-05-26-agent-handoff-gradle-isolation-index.md
```
