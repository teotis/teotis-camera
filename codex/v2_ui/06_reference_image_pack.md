...
```text
docs/evidence/v2_ui_reference_images/
```
...
```text
docs/evidence/v2_ui_reference_images/camera_cockpit_v2_main.png
```
...
```text
docs/evidence/v2_ui_reference_images/camera_cockpit_v2_recording.png
```
...
```text
docs/evidence/v2_ui_reference_images/tone_lab_v2_panel.png
```
...
```text
docs/evidence/v2_ui_reference_images/lens_lab_v2_panel.png
```
...
```text
docs/evidence/v2_ui_reference_images/pro_controls_v2_panel.png
```
...
- Store final selected PNG files in `docs/evidence/v2_ui_reference_images/`.
- Update this document if a prompt changes.
- Add a short `reference_images/README.md` if multiple versions are kept.

## Current Pack Status

The five required reference PNG files currently exist under `docs/evidence/v2_ui_reference_images/`.
...
```text
docs/evidence/v2_ui_reference_images/generate_reference_images.py
```
