...
- Apple Support: [Use the Camera Control on 参考设备](https://support.apple.com/guide/iphone/use-the-camera-control-iph0c397b154/ios). Key implication: camera controls remain consistent across photo/video and include focus/exposure/zoom semantics rather than a separate landscape-only UI.
