...
- Verified facts:
  - `docs/plans/2026-05-25-quick-panel-frame-cycle-brightness-slider.md` already defines the newer product direction, but current `activity_main.xml` still uses `buttonBrightnessMinus / buttonBrightnessValue / buttonBrightnessPlus` and `buttonFrameRatio43 / buttonFrameRatio169 / buttonFrameRatio11`.
