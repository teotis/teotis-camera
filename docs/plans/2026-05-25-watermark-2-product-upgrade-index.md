...
- `docs/plans/2026-05-24-multi-watermark-design-index.md` already planned multi-template still-photo watermark work.
- `docs/plans/2026-05-24-reversible-watermark-archive-index.md` already planned OCWM self-contained reversible watermark archive work.
