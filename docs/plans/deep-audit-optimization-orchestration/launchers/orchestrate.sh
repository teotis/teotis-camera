...
EOF
    ...
    local prompt_file="$PLAN_ROOT/launchers/agent-prompts.md"
...
Important: Only analyze, do NOT modify any source code files. Write your findings to the status file." \
        &
}
