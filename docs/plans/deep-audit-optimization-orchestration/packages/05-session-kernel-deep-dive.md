# Package 05: Session Kernel Deep Dive - Session Kernel 深度分析
...
- Session Kernel 是项目的核心，需要深入分析
- 关注 DefaultCameraSession.kt 的复杂度
- 分析 SessionDiagnostics.kt 的职责
- 不要修改任何源代码
