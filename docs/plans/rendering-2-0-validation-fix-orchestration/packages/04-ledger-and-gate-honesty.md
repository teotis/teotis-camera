...
- Verified facts:
  - `docs/plans/2026-05-25-rendering-2-0-approved-upgrade-index.md` says package status is `implemented`.
  - `docs/plans/INDEX.md` still marks Rendering 2.0 entries as `planned`.
