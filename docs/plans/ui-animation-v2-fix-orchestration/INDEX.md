...
| `docs/plans/ui-animation-v2-fix-orchestration/status/<package-id>.md` | assigned package | Other packages must not edit. |
| `docs/plans/ui-animation-v2-fix-orchestration/INDEX.md` | Codex/integration auditor only | Package agents must not edit. |
